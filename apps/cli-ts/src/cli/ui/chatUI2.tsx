...
const ChatUI = ({ session_id, query, firstMessage, chatManager }: ChatUIProps) => {
  ...
  const handleSubmit = async () => {
    ...
    const loadingMessage = { sender: 'assistant' as const, content: 'Thinking...', loading: true };
  ...
  const promptPlaceholder = messages.length > 2
    ? `Continue? ${exitNotice}`
